...
const Privacy = () => {
  ...
  return (
    <Container maxWidth="md">
      ...
      <div>
        <h5 style={{"-webkit-text-align":"center","text-align":"center"}}>Polityka Prywatności i Regulamin</h5>
        ...
        <h6 style={{"-webkit-text-align":"center","text-align":"center"}}>§ 1 Definicje</h6>
        <ul>
          <li><p><strong>Serwis</strong> - serwis internetowy działający pod adresem <span id="serwis"><span className={classes.colored}>loveli.pl</span></span></p></li>
          <li><p><strong>Serwis zewnętrzny</strong> - serwis internetowe partnerów, usługodawców lub usługobiorców Administratora</p></li>
          <li><p><strong>Administrator</strong> - firma <span id="firma"><span className={classes.colored}>Loveli</span>, prowadząca działalność pod adresem: <span className={classes.colored}>leveli.pl</span>, o nadanym numerze identyfikacji podatkowej (NIP): <span className={classes.colored}>- </span></span>, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu oraz przechowująca i uzyskująca dostęp do informacji w urządzeniach Użytkownika</p></li>
        ...
        <h6 style={{"-webkit-text-align":"center","text-align":"center"}}>§ 2 Rodzaje Cookies</h6>
        <ul>
        ...
        <h6 style={{"-webkit-text-align":"center","text-align":"center"}}>§ 3 Bezpieczeństwo</h6>
        <ul>
        ...
        <h6 style={{"-webkit-text-align":"center","text-align":"center"}}>§ 4 Cele do których wykorzystywane są pliki Cookie</h6>
        <ul id="cele" />
        <h6 style={{"-webkit-text-align":"center","text-align":"center"}}>§ 5 Serwisy zewnętrzne</h6>
        <p id="zewinfo"><span className={classes.colored}>Administrator nie współpracuje z serwisami zewnętrznymi i Serwis nie umieszcza ani nie korzysta z żadnych plików zewnętrznych plików Cookie.</span></p>
        <ul id="zewnetrzne" />
        <h6 style={{"-webkit-text-align":"center","text-align":"center"}}>§ 6 Możliwości określania warunków przechowywania i uzyskiwania dostępu na Urządzeniach Użytkownika przez Serwis<span id="sz6" style={{"display":"none"}}> i Serwisy zewnętrzne</span></h6>
        <ul>
        ...
        <h6 style={{"-webkit-text-align":"center","text-align":"center"}}>§ 7 Wymagania Serwisu</h6>
        <ul>
        ...
        <h6 style={{"-webkit-text-align":"center","text-align":"center"}}>§ 8 Zmiany w Polityce Cookie</h6>
        <ul>
